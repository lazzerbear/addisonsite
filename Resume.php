      ...
      -->
            ...
            <div class="col-xs-7">
                <div class="media">
                    <div class="media-left">
                        <a href="img/Addison Martin.jpg">
                            <img class="media-object img-rounded" src="img/Addison Martin.jpg" alt="Addison S. Martin" hight="200" width="200"> </a>
                    </div>
                    <div class="media-body">
                        <div class="media-body">
                            <h2 class="media-heading">Web Developer</h2><br>
                            <p> I am a new web developer looking to create <br> fun and interesting content on the web.
                                <p>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-8 col-lg-7">
                ...
                <p>Working to create content to help customers find what they are looking for. <br> Making responsive and interactive web designs that get people to what they need in style.</p>
                <div class="row">
                    <div class="col-xs-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-6 col-xs-6">
                    <p><a href="http://fullmoonsupplements.com/">FullMoonSupplements</a><br> A coming soon page for an amazing dedicated supplements provider.</p>
                    <hr class="hidden-lg">
                </div>
                <div class="col-lg-4 col-sm-6 col-xs-6">
                    <hr class="hidden-lg">
                </div>
                <div class="col-lg-4 col-sm-6 col-xs-6"></div>
                <div class="col-lg-4 col-sm-6 col-xs-6 hidden-lg"></div>
            </div>
            <hr>
            <!-- second row for portfolio
        <div class="row">
